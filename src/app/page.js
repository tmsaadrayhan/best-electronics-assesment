...
const page = () => {
  ...
  return (
    ...
    >
      {/* nav */}
      <div className="w-[300px] bg-[#FFFFFF]">
        <div className="bg-[#F15B25] w-full">
          <Image
            className="mx-auto w-[200px] py-[1rem] pointer"
            src={onnow}
            alt="onnow"
          />
        </div>
        <div className="mt-[2.5rem] mx-[2.5rem] divide-[#DEDEDE] divide-[2px] divide-y text-[#6F6F6F] text-xl">
          <div>
            <div className="flex my-[2rem] pointer">
              <div>
      ...
      <div className="mt-[2rem] ms-[2rem]">
        <div className="my-[1rem] flex text-xl">
          <div className="relative group">
            <button className="bg-[#FFFFFF] hover:bg-[#F15B2525] hover:border-[#F15B25] border text-2xl font-bold h-[70px] w-[270px] rounded-xl">
              All Brands
            </button>
            <div className="hidden group-hover:block triangle ms-[125px]"></div>
          </div>
          <div className="relative group h-fit">
            <button className="flex bg-[#FFFFFF] hover:bg-[#F15B2525] hover:border-[#F15B25] items-center border font-bold h-[70px] w-[270px] rounded-xl ms-[1.5rem]">
              <div className="me-[1rem] ms-[1.5rem]">
                <Image src={Group131} alt="onnow" />
              </div>
              <p>Party Pizza</p>
            </button>
            <div className="hidden group-hover:block triangle ms-[140px]"></div>
          </div>
          <div className="relative group h-fit">
            <button className="flex bg-[#FFFFFF] hover:bg-[#F15B2525] hover:border-[#F15B25] items-center border font-bold h-[70px] w-[270px] rounded-xl ms-[1.5rem]">
              <div className="me-[1rem] ms-[1.5rem]">
        ...
        <div className="flex divide-x divide-[#B0B0B0] bg-[#FFFFFF] rounded-xl text-xl text-[#979797] mt-[3rem] p-[1rem]">
          <div className="w-[20%] p-[0.5rem]">
            <h1>Total orders</h1>
            <p className="text-[#F15B25] text-3xl font-black mt-[0.5rem]">
              136
            </p>
          </div>
          <div className="w-[26%] flex justify-center p-[0.5rem]">
            <div>
              <h1>Total sales</h1>
              <p className="text-[#F15B25] text-3xl font-black mt-[0.5rem]">
                32652৳
          ...
          <div className="w-[26%] flex justify-end p-[0.5rem]">
            <div>
        ...
        <div className="flex mt-[1.5rem]">
            ...
            <div>
              <div className="flex items-center">
                <div className="grow ms-[2rem]">
                  <h1 className="text-xl font-bold">Total orders by source</h1>
                </div>
                <button className="text-sm flex items-center border rounded-full px-[1rem]">
                  January{" "}
                  <Image
                ...
                <button className="text-sm flex items-center border rounded-full px-[1rem] ms-[1rem]">
                  Select an outlet{" "}
                  <Image
                    className="mx-auto ms-[1rem] py-[1rem]"
                    src={Vector632}
              ...
              ></div>
              <div>
                <div className="flex font-[600] text-sm items-center px-[1rem] ms-[1rem]">
                  <div className="bg-[#7BB0FF] w-[1rem] h-[1rem]"></div>
                  <p className="text-[#7BB0FF] ms-[.5rem]">Web</p>
                  <div className="bg-[#FF569D] w-[1rem] h-[1rem] ms-[1rem]"></div>
          ...
          <div className="relative bg-[#FFFFFF] rounded-xl ms-[1rem] p-[1rem] ps-[2rem]">
            <div className="w-[550px] h-[200px]">
              <h2 className="text-xl font-bold">Total orders by outlet</h2>
              <div
                style={{
                  height: "3px",
                  width: "150px",
            ...
            <div className="absolute top-[2rem] right-[2.5rem]">
              <Image
                className="w-[12px] pointer rotate-180"
                src={Vector632}
                alt="Vector632"
              />
              <Image
                className="mt-[10px] w-[12px] pointer"
                src={Vector632}
                alt="Vector632"
              />
            </div>

            <div className="absolute bg-[#BEBEBE] top-[1rem] right-[1rem] w-[8px] h-[200px] rounded-full">
